  ...
  return (
    <Box mt={4} p={5}>
      <Container maxW={"7xl"} py={16} as={Stack} spacing={12}>
        ...
        >
          <CarCard image="front5.webp" carName="Yamaha" model="2022" />
          <CarCard image="front2.webp" carName="Toyota" model="2021" />
          <CarCard image="front1.webp" carName="Avanza" model="2019" />
        </Stack>
      </Container>
    </Box>
  );
